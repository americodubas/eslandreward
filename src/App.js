                ...
                onClick={() => {
                  ...
                  setTimeout(() => {
                    ...
                    for (let el of localArea(col.limits).filter(
                      ...
                      if (
                        element.classList[2] === "rp" &&
                        !element.classList.contains("guild")
                      ) {
...
function App() {
  ...
  const dataGuild = [
    ...
    { x: 42, y: 36, name: "Thaii" },
    { x: 43, y: 149, name: "W1LL" },
    ...
    { x: 72, y: 134, name: "Nicolas" },
    { x: 73, y: 52, name: "Matheussao" },
    { x: 73, y: 151, name: "Nephalem" },
    { x: 74, y: 173, name: "Shaman" },
    { x: 76, y: 22, name: "Mandy Tyrell" },
    { x: 76, y: 35, name: "Bazin" },
    { x: 78, y: 21, name: "Conezord" },
    { x: 84, y: 47, name: "RIDER" },
    { x: 86, y: 159, name: "LuigiGF" },
    { x: 87, y: 174, name: "IrmaoCaneca" },
    { x: 91, y: 21, name: "Diego" },
    { x: 92, y: 21, name: "LucasDrachen" },
